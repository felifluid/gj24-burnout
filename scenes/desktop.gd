...
func getTime() -> float:
	...
	return (ellapsed_time / dayTimer.wait_time) * dayHours + 8 # 10 hour work day, starting at 8 am
...
func updateClock() -> void:
	...
	if (dayTimer.wait_time - dayTimer.time_left > dayTimer.wait_time / dayHours * 8):
